...
int main() {
    ...
    if (iResult != 0) {
        cout << "WSAStartup çàâåðøèëñÿ ñ îøèáêîé: " << iResult << "\n";
        cout << "ïîäêëþ÷åíèå Winsock.dll ïðîøëî ñ îøèáêîé!\n";
        return 1;
    }
    ...
    if (iResult != 0) {
        cout << "getaddrinfo çàâåðøèëñÿ ñ îøèáêîé: " << iResult << "\n";
        cout << "ïîëó÷åíèå àäðåñà è ïîðòà ñåðâåðà ïðîøëî c îøèáêîé!\n";
        WSACleanup();
        return 2;
    }
    ...
    if (ListenSocket == INVALID_SOCKET) {
        cout << "socket çàâåðøèëñÿ ñ îøèáêîé: " << WSAGetLastError() << "\n";
        cout << "ñîçäàíèå ñîêåòà ïðîøëî c îøèáêîé!\n";
        freeaddrinfo(result);
        WSACleanup();
        return 3;
    }
    ...
    if (iResult == SOCKET_ERROR) {
        cout << "bind çàâåðøèëñÿ ñ îøèáêîé: " << WSAGetLastError() << "\n";
        cout << "âíåäðåíèå ñîêåòà ïî IP-àäðåñó ïðîøëî ñ îøèáêîé!\n";
        freeaddrinfo(result);
    ...
    if (iResult == SOCKET_ERROR) {
        cout << "listen çàâåðøèëñÿ ñ îøèáêîé: " << WSAGetLastError() << "\n";
        cout << "ïðîñëóøèâàíèå èíôîðìàöèè îò êëèåíòà íå íà÷àëîñü. ÷òî-òî ïîøëî íå òàê!\n";
        closesocket(ListenSocket);
        WSACleanup();
        return 5;
    }
    ...
    if (ClientSocket == INVALID_SOCKET) {
        cout << "accept çàâåðøèëñÿ ñ îøèáêîé: " << WSAGetLastError() << "\n";
        cout << "ñîåäèíåíèå ñ êëèåíòñêèì ïðèëîæåíèåì íå óñòàíîâëåíî! ïå÷àëü!\n";
        closesocket(ListenSocket);
        WSACleanup();
        return 6;
    }
